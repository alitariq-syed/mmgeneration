...
_base_ = [
    '../_base_/datasets/places365_stylegan_ali.py',
...
data = dict(
    samples_per_gpu=1, #4
    train=dict(dataset=dict(imgs_root='G:/Places365_small/val_256/train_samples'))) #imgs_root='./data/lsun-church'
...
checkpoint_config = dict(interval=10, by_epoch=False, max_keep_ckpts=2) #max_keep_ckpts=30
lr_config = None
...
total_iters = 100 #800002  # need to modify

metrics = dict(
    fid50k=dict(
        type='FID', num_images=500, inception_pkl=None, bgr2rgb=True),
